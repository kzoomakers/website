...
(function() {
  ...
  function generateContactCardHours(data) {
    ...
    return `
      ...
      <p style="color: #666; margin-top: 10px; font-size: 0.9em;">Closed: ${schedule.closedDaysShort.join(' & ')}</p>
    `;
  }
      ...
      <div class="card shadow-sm" style="border: none; border-radius: 10px;">
        <div class="card-body text-center p-5">
          ...
          <div class="hours-list" style="font-size: 1.1em; line-height: 2;">
            ...
            <p style="margin: 0; color: #999; font-size: 0.95em;">Closed: ${schedule.closedDays.join(' & ')}</p>
          </div>
  ...
  function generateFooterHours(data) {
    ...
    return `
      <ul>
        ...
        <li><a href="contact.html">Closed: ${schedule.closedDaysShort.join(' & ')}</a></li>
      </ul>
    `;
  }
